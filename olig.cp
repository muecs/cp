...
CorrectIlluminationApply:[module_num:5|svn_version:\'10300\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Select the input image:RedOriginal
    Name the output image:RedCorrected
...
ConserveMemory:[module_num:6|svn_version:\'9401\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Specify which images?:Images to keep
    Select image to keep:RedCorrected
    Select image to keep:GreenCorrected

RescaleIntensity:[module_num:7|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:RedCorrected
    Name the output image:RedRescaled
...
ApplyThreshold:[module_num:8|svn_version:\'6746\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Select the input image:RedRescaled
...
EnhanceOrSuppressFeatures:[module_num:9|svn_version:\'10591\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:RedThresh
    Name the output image:RedFiltered
...
IdentifyPrimaryObjects:[module_num:10|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
    Select the input image:RedFiltered
...
ConserveMemory:[module_num:14|svn_version:\'9401\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Specify which images?:Images to keep
    Select image to keep:RedFiltered
    Select image to keep:GreenFiltered

GrayToColor:[module_num:15|svn_version:\'10341\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select a color scheme:RGB
    Select the input image to be colored red:RedFiltered
    Select the input image to be colored green:GreenFiltered
...
ExportToSpreadsheet:[module_num:17|svn_version:\'10880\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    Press button to select measurements to export:Image\x7CCount_RedObjects,Image\x7CCount_GreenObjects,Image\x7CFileName_Original,Image\x7CMetadata_Group,Image\x7CMetadata_Number
