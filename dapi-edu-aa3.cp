...
EnhanceOrSuppressFeatures:[module_num:8|svn_version:\'10591\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
ConvertObjectsToImage:[module_num:11|svn_version:\'10807\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select the input objects:GreenObjects
    Name the output image:GreenObjectsImg
    Select the color type:Grayscale
    Select the colormap:Default

RelateObjects:[module_num:12|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
